            ...
            items.forEach(function(item){
                item.addEventListener('click', function (e) {
                    ...
                    for (var i = 0; i < elements.length; i++) {
                        ...
                        var size = [elements[i].querySelector("img").naturalWidth, elements[i].querySelector("img").naturalHeight];
                        // console.log('size[0]' ,size[0]);
                        // console.log('size[1]' ,size[1]);

                        // console.log("elements[i].clientWidth", elements[i].querySelector("img").clientWidth);
                        // size[0] = 400;
                        // size[1] = 500;
                        items[i] =
                            {
                        ...
                        // console.log("items[i].w ",items[i].w)
                    }
